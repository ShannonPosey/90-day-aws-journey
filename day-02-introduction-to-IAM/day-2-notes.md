...
__Creation Date:__ Dec 12, 2025  
__Created By:__ Shannon Posey  
[View most recent version on Tango.ai](https://app.tango.us/app/workflow/5bb6cc2b-2999-480c-94ad-6c4e1331f27b?utm_source=markdown&utm_medium=markdown&utm_campaign=workflow%20export%20links)
...
**Problem:** [Brief description] One of the user I created, I gave permission to have full access to an EC2 instance. When the user tried to connect to the instance using EC2 Instance connect the user did not have the correct permissions
