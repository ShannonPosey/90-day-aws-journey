...
2. Instance types matter becuase they determine how much CPU, memory, and network performance I get, and choosing the wrong one can cost money or performance
...
**New Terms:**
- **EC2 Instance:** A vitrual machine in AWS that I can configure, start, stop, and terminate as needed.
...
**Solution:** 
I discovered the issue was local, not AWS-related. The SSH key pair file permission needed to be changed to read-only for the file owner.
...
- Apache Web Server - Status: Deactive
